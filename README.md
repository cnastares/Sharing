...
* **`sharing.exe`**: Ejecutable portable autocontenido para Windows.
...
### En Windows (Cliente)
1. Descarga el ejecutable portable **`sharing.exe`** en tu computadora Windows (ej. en tu Escritorio).
2. Haz doble clic sobre **`sharing.exe`**.
